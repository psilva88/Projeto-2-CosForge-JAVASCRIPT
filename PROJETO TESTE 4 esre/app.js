...
function App() {
    ...
    return (
        <div className="app-wrapper">
            {telaAtual !== 'login' && <Navbar mudarTela={mudarTela} usuarioLogado={usuarioLogado} telaAtual={telaAtual} />}
    ...
    return (
        <nav className="navbar">
            <div className="nav-topo">
                ...
                {usuarioLogado ? (
                    <div className="perfil-usuario perfil-topo" onClick={() => navegar('login')}>
