...
function SobreNos() {
    const membros = [
        { inicial: 'A', nome: 'Arthur Pereira', papel: 'Dev Front-end' },
        { inicial: 'R', nome: 'Rodrigo Lira', papel: 'Dev Front-end' },
        ...
        <div className="container-pagina">
            ...
            <div className="hero-banner" style={{marginBottom: '32px'}}>
                ...
                <h3>
                    ...
                    centralizar tudo que um cosplayer precisa em um lugar só — com orçamento real e tempo estimado.
                </h3>
            </div>
