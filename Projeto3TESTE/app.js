...
function Navbar({ mudarTela, usuarioLogado, telaAtual }) {
    ...
    function irParaBounty() {
        // se já estiver na home, rola direto sem piscar
        if (telaAtual === 'home') {
            let secao = document.getElementById('secao-bounty');
            if (secao) secao.scrollIntoView({ behavior: 'smooth' });
        } else {
            mudarTela('home');
            // espera o React renderizar a home antes de rolar
            setTimeout(function() {
                let secao = document.getElementById('secao-bounty');
                if (secao) secao.scrollIntoView({ behavior: 'smooth' });
            }, 80);
    ...
    return (
        <nav className="navbar">
            <div className="nav-esquerda">
                ...
                <button className="btn-nav" onClick={() => mudarTela('sobre')}>Sobre Nós</button>
        ...
        <div className="container-pagina bounty-page">
            ...
            <div className="novo-bounty-form">
                ...
                <div className="novo-bounty-input">
                    <input
                        type="text"
                        placeholder="Ex: Espada do Cloud Strife (FF7)"
                        value={novoPedido}
